...
class USVisaRescheduler:
    ...
    def get_date(self):
        script = f"""
            ...
            xhr.open('GET', '{self._check_date_url}', false);
    ...
    def is_logged_in(self):
        ...
        if content.find("error") != -1 and "Your session expired, please sign in again to continue." in content:
            return False
        return True
